...
public final class GUI extends Application {
    private static PhoneBook phoneBook;// interface to database
    ...
    /**
     * Purpose: construct the GUI and add a keyboard listener to capture the users
    ...
    /**
     * Purpose: display a message to request data and read in the String data uisng
     * a dialog box
     * 
    ...
    /**
     * Purpose: reads in the Person data (name/phone) using two dialog boxes creates
    ...
    /**
     * Purpose: Assigns the AddressBook to use so GUI can communicate with it. Note
     * that since a GUI is event driven unlike the Console this method has limited
     * use here.
     * 
    ...
    /**
     * Purpose: When the user makes their selection the Keyboard listener stores the
     * selection value in data member "choice" and then calls this method. Based on
     * the users choice we call the appropriate method on the addressBook.
     */
